...
handler.all = async function (m) {
	...
	try {
		...
		global.kontak2 = [
         ...
         [owner[1], await this.getName(owner[1] + '628@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'cc@gmail.com', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
